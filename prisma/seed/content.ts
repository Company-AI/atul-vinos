...
export const CMS_SECTIONS = [
  ...
  },
  {
    ...
    data: {
      ...
      tone: "light",
      items: [
        { title: "Toda Malbec", subtitle: "La misma uva, distintas zonas", imageUrl: "/media/packs/pack-malbec.webp", href: "/box" },
        { title: "Ruta Argentina", subtitle: "Un recorrido de norte a sur", imageUrl: "/media/packs/pack-uco.webp", href: "/box" },
        { title: "Para el asado", subtitle: "Lo que funciona en la parrilla", imageUrl: "/media/packs/pack-asado.webp", href: "/box" },
        { title: "Para regalar", subtitle: "Alta gama, listo para entregar", imageUrl: "/media/packs/pack-regalo.webp", href: "/box" },
      ],
    },
  },
  {
